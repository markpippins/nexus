/**
 * sandbox-guard.ts — capability + resource guard for the projection-core pasted-code
 ...
 * tracked with the projection-core roadmap; the guards here close the common exfiltration
