 ...
 *
 * TOPOLOGY: :4114, the canary/deployment twin of typescript/voyager-srv
 * (:3114). Joins the NATS mesh in namespace "voyager" — same substrate as
 * search (:4050, namespace "search") and solscript (:4060, namespace
 * "solscript"), with isolated discovery. NATS is live fleet infrastructure on
