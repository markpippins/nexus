...
//
// TOPOLOGY: :4114 is the CANARY twin of typescript/voyager-srv (:3114) and is
...
// the NATS transporter (namespace "voyager", mirroring solscript) for the
// mesh-joined deployment; namespace isolation keeps the domains separate on
// the shared :4222 bus.
