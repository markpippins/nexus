 ...
 *
 * TOPOLOGY: :4106, the canary/deployment twin of typescript/cascade-srv
 * (:3106). Joins the NATS mesh in namespace "cascade" — same substrate as
