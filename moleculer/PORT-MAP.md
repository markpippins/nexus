...
| Namespaces | one per service family: `search`, `solscript`, `broker`, `voyager`, `cascade`, `kernel`, `draft`, `knowledge`, `role-memory`, `semantics`, `tackle` |
...
- Canary/deployment ports (4100/4106/4109/4114/4150/4170/4410) are the exception to
  ...
  the port-band), 4150/4160 submitted for ratification with their PRs, and
  4410 (+1000 band, submitted with the tackle PR) extends the same scheme;
