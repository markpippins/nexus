...
| Namespaces | one per service family: `search`, `solscript`, `broker`, `voyager`, `cascade`, `kernel`, `draft`, `knowledge`, `role-memory`, `semantics`, `tackle`, `prompt-sync`, `execution`, `conduit` |
...
- Canary/deployment ports (4100/4104/4106/4109/4110/4114/4150/4170/4410/4501) are the exception to
