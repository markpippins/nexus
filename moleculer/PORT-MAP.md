...
| Namespaces | one per service family: `search`, `solscript`, `broker`, `voyager`, `cascade`, `kernel`, `draft`, `knowledge`, `role-memory`, `semantics`, `prompt-sync`, `execution` |
...
- Canary/deployment ports (4100/4106/4109/4110/4114/4150/4170/4501) are the exception to
  ...
  band, submitted with the prompt-sync PR) extends the same scheme; 4110
