 ...
 *
 * TOPOLOGY: :4150, the canary/deployment twin of typescript/role-memory-srv
 * (:3500). Joins the NATS mesh in namespace "role-memory" — same substrate
 * as search (:4050), solscript (:4060), cascade (:4106), kernel (:4100),
 * knowledge (:4109) and draft (:4170), with isolated discovery. NATS is
