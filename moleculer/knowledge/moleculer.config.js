 ...
 *
 * TOPOLOGY: :4109, the canary/deployment twin of typescript/knowledge-srv
 * (:3109). Joins the NATS mesh in namespace "knowledge" — same substrate as
 * search (:4050), solscript (:4060), cascade (:4106), kernel (:4100) and
 * draft (:4170), with isolated discovery. NATS is live fleet infrastructure
 * on :4222; `nats` is a dependency of this service.
 *
