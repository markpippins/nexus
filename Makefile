...
v192-blackboard-e2e-test:
	@echo "[v192-blackboard-e2e-test] V192 coordination checkpoints + blackboard view E2E (preflights, routing, bucket logic, inbox fold, throwaway DB, wr-conf-044)..."
	@python3 -m pytest python/nexus_core/wrp/tests/test_v192_blackboard_e2e.py -v
